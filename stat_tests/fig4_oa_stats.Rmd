...
```{r}
# Running linear mi
m_ct <- lmer(Total_Time ~ Block_num*Target_Name + (1|Participant), data=oa_target_data)
...
m_orict <- lmer(Orientation_Time ~ Block_num*Target_Name + (1|Participant), data=oa_target_data)
...
```{r}
# Running linear mixed model
m_navct <- lmer(Navigation_Time ~ Block_num*Target_Name + (1|Participant), data=oa_target_data)
...
```{r}
# Running linear mixed model
m_dt <- lmer(Distance ~ Block_num*Target_Name + (1|Participant), data=oa_target_data)
...
```{r}
# Running linear mixed model
m_speed <- lmer(Speed ~ Block_num*Target_Name + (1|Participant), data=oa_target_data)
...
```{r}
# Running linear mixed model
m_dwell <- lmer(Mean_Dwell ~ Block_num*Target_Name + (1|Participant), data=oa_target_data)
...
```{r}
# Running linear mixed model
m_teleport <- lmer(Teleportations ~ Block_num*Target_Name + (1|Participant), data=oa_target_data)
...
csv_file <- paste0(output_directory, "oa_combined_anova_data.csv")
...
# Define the CSV file name
csv_file <- paste0(output_directory, "oa_combined_block_data.csv")
...
# Define the CSV file name
csv_file <- paste0(output_directory, "oa_combined_blocktarget_data.csv")
...
# Define the CSV file name
csv_file <- paste0(output_directory, "oa_combined_target_data.csv")
