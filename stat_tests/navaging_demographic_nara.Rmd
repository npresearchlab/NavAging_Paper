...
gender_nara <- data.frame(alldata$gender,alldata$nara_score)
gender_nara <- table(alldata$gender,alldata$nara_score)
print(gender_nara)
print(chisq.test(age_presence))

# running chi square with/without Yates correction

chisq.test(table(alldata$gender, alldata$nara_score), correct = TRUE)
chisq.test(table(alldata$gender, alldata$nara_score), correct = FALSE)
