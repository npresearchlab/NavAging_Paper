...
# Age_Group factor levels: YA (reference) â†' OA
...
# Block_Num factor levels: 1 â†' 2 â†' 3 (learning progression)
...
for (outcome in outcome_vars) {
  ...
  effect_sizes_age <- eff_size(pairs(emm_age, adjust = "fdr"), 
                               sigma = sigma(m_outcome), 
                               edf = df.residual(m_outcome))
  ...
  contrasts_age_df$cohens_d <- summary(effect_sizes_age)$effect.size
  ...
  # Calculate effect sizes (Cohen's d)
  effect_sizes_block <- eff_size(pairs(emm_block, adjust = "fdr"), 
                                 sigma = sigma(m_outcome), 
                                 edf = df.residual(m_outcome))
  ...
  # Add effect size column
  contrasts_block_df$cohens_d <- summary(effect_sizes_block)$effect.size
  ...
  # Calculate effect sizes (Cohen's d)
  effect_sizes_age_within_block <- eff_size(pairs(emm_interaction, simple = "Age_Group", adjust = "fdr"), 
                                           sigma = sigma(m_outcome), 
                                           edf = df.residual(m_outcome))
  ...
  # Add effect size column
  contrasts_age_within_block_df$cohens_d <- summary(effect_sizes_age_within_block)$effect.size
  ...
  # Calculate effect sizes (Cohen's d)
  effect_sizes_block_within_age <- eff_size(pairs(emm_interaction, simple = "Block_Num", adjust = "fdr"), 
                                           sigma = sigma(m_outcome), 
                                           edf = df.residual(m_outcome))
  ...
  # Add effect size column
  contrasts_block_within_age_df$cohens_d <- summary(effect_sizes_block_within_age)$effect.size
  ...
  # Calculate effect sizes (Cohen's d)
  effect_sizes_interaction <- eff_size(contrast(block_changes_within_age, "pairwise", 
                                               by = "contrast", adjust = "fdr"), 
                                     sigma = sigma(m_outcome), 
                                     edf = df.residual(m_outcome))
  ...
  # Add effect size column
  interaction_changes_df$cohens_d <- summary(effect_sizes_interaction)$effect.size
