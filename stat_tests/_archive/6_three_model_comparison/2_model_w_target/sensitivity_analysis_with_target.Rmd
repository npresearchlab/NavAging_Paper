...
sensitivity_data <- read_excel("/Volumes/YB_Drive/NavAging_Paper/stat_tests/2_model_w_target/pval_template.xlsx")

# Read the two data CSV files
age_group_data <- read_csv("/Volumes/YB_Drive/NavAging_Paper/stat_tests/2_model_w_target/all_contrasts_age_group.csv")
interaction_data <- read_csv("/Volumes/YB_Drive/NavAging_Paper/stat_tests/2_model_w_target/all_contrasts_interaction.csv")
```
...
write_csv(sensitivity_results, "pvalues_with_target.csv")

cat("✓ Results saved to: pvalues_with_target.csv\n")
```
