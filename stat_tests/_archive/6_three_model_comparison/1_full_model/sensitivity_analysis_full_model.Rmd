...
sensitivity_data <- read_excel("/Volumes/YB_Drive/NavAging_Paper/stat_tests/1_full_model/pval_template.xlsx")

# Read the two data CSV files
age_group_data <- read_csv("/Volumes/YB_Drive/NavAging_Paper/stat_tests/1_full_model/all_contrasts_age_group.csv")
interaction_data <- read_csv("/Volumes/YB_Drive/NavAging_Paper/stat_tests/1_full_model/all_contrasts_interaction.csv")
```
...
write_csv(sensitivity_results, "pvalues_full_model.csv")

cat("✓ Results saved to: pvalues_full_model.csv\n")
```
