...
model_data <- read_excel("/Volumes/YB_Drive/NavAging_Paper/stat_tests/1_main_lmm/pval_template_main.xlsx")
...
age_group_data <- read_csv("/Volumes/YB_Drive/NavAging_Paper/stat_tests/1_main_lmm/all_contrasts_age_group.csv")
interaction_data <- read_csv("/Volumes/YB_Drive/NavAging_Paper/stat_tests/1_main_lmm/all_contrasts_interaction.csv")
interaction_changes_data <- read_csv("/Volumes/YB_Drive/NavAging_Paper/stat_tests/1_main_lmm/all_interaction_changes.csv")
...
write_csv(pvalue_extraction_results, "final_pvalues.csv")

cat("✓ Results saved to: final_pvalues.csv\n")
```
