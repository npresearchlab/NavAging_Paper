...
```{r}
# Running linear mi
m_ct <- lmer(Total_Time ~ Block_num*Target_Name + (1|Participant), data=all_target_data)
...
m_orict <- lmer(Orientation_Time ~ Block_num*Target_Name + (1|Participant), data=all_target_data)
...
```{r}
# Running linear mixed model
m_navct <- lmer(Navigation_Time ~ Block_num*Target_Name + (1|Participant), data=all_target_data)
...
```{r}
# Running linear mixed model
m_dt <- lmer(Distance ~ Block_num*Target_Name + (1|Participant), data=all_target_data)
