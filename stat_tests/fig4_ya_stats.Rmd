...
```{r}
# Running linear mi
m_ct <- lmer(Total_Time ~ Block_num*Target_Name + (1|Participant), data=ya_target_data)
...
m_orict <- lmer(Orientation_Time ~ Block_num*Target_Name + (1|Participant), data=ya_target_data)
...
```{r}
# Running linear mixed model
m_navct <- lmer(Navigation_Time ~ Block_num*Target_Name + (1|Participant), data=ya_target_data)
...
```{r}
# Running linear mixed model
m_dt <- lmer(Distance ~ Block_num*Target_Name + (1|Participant), data=ya_target_data)
...
```{r}
# Running linear mixed model
m_speed <- lmer(Speed ~ Block_num*Target_Name + (1|Participant), data=ya_target_data)
...
```{r}
# Running linear mixed model
m_dwell <- lmer(Mean_Dwell ~ Block_num*Target_Name + (1|Participant), data=ya_target_data)
...
```{r}
# Running linear mixed model
m_teleport <- lmer(Teleportations ~ Block_num*Target_Name + (1|Participant), data=ya_target_data)
...
csv_file <- paste0(output_directory, "ya_combined_anova_data.csv")
...
# Define the CSV file name
csv_file <- paste0(output_directory, "ya_combined_block_data.csv")
...
# Define the CSV file name
csv_file <- paste0(output_directory, "ya_combined_blocktarget_data.csv")
...
# Define the CSV file name
csv_file <- paste0(output_directory, "ya_combined_target_data.csv")
...
heatmap_speed
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/NavAging_Paper/figure_creation/plots/fig4_ya_heatmap_speed.svg", height = 6, width = 6, plot=heatmap_speed)
```
...
heatmap_ct <- ggplot(data_m_ct_targetonly, aes(x = t1, y = t2, fill = p.value.adj)) +
  ...
  scale_y_discrete(labels=c("T1","T2","T3","T4","T5","T6","T7","T8"))
heatmap_ct
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/NavAging_Paper/figure_creation/plots/fig4_ya_heatmap_ct.svg", height = 6, width = 6, plot=heatmap_ct)
```
...
heatmap_orict <- ggplot(data_m_orict_targetonly, aes(x = t1, y = t2, fill = p.value.adj)) +
  ...
  scale_y_discrete(labels=c("T1","T2","T3","T4","T5","T6","T7","T8"))
heatmap_orict
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/NavAging_Paper/figure_creation/plots/fig4_ya_heatmap_orict.svg", height = 6, width = 6, plot=heatmap_orict)
```
...
heatmap_navct <- ggplot(data_m_navct_targetonly, aes(x = t1, y = t2, fill = p.value.adj)) +
  ...
  scale_y_discrete(labels=c("T1","T2","T3","T4","T5","T6","T7","T8"))
heatmap_navct
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/NavAging_Paper/figure_creation/plots/fig4_ya_heatmap_navct.svg", height = 6, width = 6, plot=heatmap_navct)
```
...
heatmap_dt <- ggplot(data_m_dt_targetonly, aes(x = t1, y = t2, fill = p.value.adj)) +
  ...
  scale_y_discrete(labels=c("T1","T2","T3","T4","T5","T6","T7","T8"))
heatmap_dt
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/NavAging_Paper/figure_creation/plots/fig4_ya_heatmap_dt.svg", height = 6, width = 6, plot=heatmap_dt)
```
...
heatmap_dwell <- ggplot(data_m_dwell_targetonly, aes(x = t1, y = t2, fill = p.value.adj)) +
  ...
  scale_y_discrete(labels=c("T1","T2","T3","T4","T5","T6","T7","T8"))
heatmap_dwell
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/NavAging_Paper/figure_creation/plots/fig4_ya_heatmap_dwell.svg", height = 6, width = 6, plot=heatmap_dwell)
```
...
heatmap_teleport <- ggplot(data_m_teleport_targetonly, aes(x = t1, y = t2, fill = p.value.adj)) +
  ...
  scale_y_discrete(labels=c("T1","T2","T3","T4","T5","T6","T7","T8"))
heatmap_teleport
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/NavAging_Paper/figure_creation/plots/fig4_ya_heatmap_teleport.svg", height = 6, width = 6, plot=heatmap_teleport)
```
...
fig5_heatmap_speed <- ggplot(data_m_speed_blocktarget, aes(x = contrast, y = Target_Name, fill = p.value.adj)) +
  ...
  scale_y_discrete(labels=c("T1","T2","T3","T4","T5","T6","T7","T8"))
fig5_heatmap_speed
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/NavAging_Paper/figure_creation/plots/fig5_ya_heatmap_speed.svg", height = 6, width = 6, plot=fig5_heatmap_speed)
```
...
fig5_heatmap_ct <- ggplot(data_m_ct_blocktarget, aes(x = contrast, y = Target_Name, fill = p.value.adj)) +
  ...
  scale_y_discrete(labels=c("T1","T2","T3","T4","T5","T6","T7","T8"))
fig5_heatmap_ct
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/NavAging_Paper/figure_creation/plots/fig5_ya_heatmap_ct.svg", height = 6, width = 6, plot=fig5_heatmap_ct)
```
...
fig5_heatmap_orict <- ggplot(data_m_orict_blocktarget, aes(x = contrast, y = Target_Name, fill = p.value.adj)) +
  ...
  scale_y_discrete(labels=c("T1","T2","T3","T4","T5","T6","T7","T8"))
fig5_heatmap_orict
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/NavAging_Paper/figure_creation/plots/fig5_ya_heatmap_orict.svg", height = 6, width = 6, plot=fig5_heatmap_orict)
```
...
fig5_heatmap_navct <- ggplot(data_m_navct_blocktarget, aes(x = contrast, y = Target_Name, fill = p.value.adj)) +
  ...
  scale_y_discrete(labels=c("T1","T2","T3","T4","T5","T6","T7","T8"))
fig5_heatmap_navct
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/NavAging_Paper/figure_creation/plots/fig5_ya_heatmap_navct.svg", height = 6, width = 6, plot=fig5_heatmap_navct)
```
...
fig5_heatmap_dt <- ggplot(data_m_dt_blocktarget, aes(x = contrast, y = Target_Name, fill = p.value.adj)) +
  ...
  scale_y_discrete(labels=c("T1","T2","T3","T4","T5","T6","T7","T8"))
fig5_heatmap_dt
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/NavAging_Paper/figure_creation/plots/fig5_ya_heatmap_dt.svg", height = 6, width = 6, plot=fig5_heatmap_dt)
```
...
fig5_heatmap_dwell <- ggplot(data_m_dwell_blocktarget, aes(x = contrast, y = Target_Name, fill = p.value.adj)) +
  ...
  scale_y_discrete(labels=c("T1","T2","T3","T4","T5","T6","T7","T8"))
fig5_heatmap_dwell
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/NavAging_Paper/figure_creation/plots/fig5_ya_heatmap_dwell.svg", height = 6, width = 6, plot=fig5_heatmap_dwell)
```
...
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/NavAging_Paper/figure_creation/plots/fig5_ya_heatmap_teleport.svg", height = 6, width = 6, plot=fig5_heatmap_teleport)
```
