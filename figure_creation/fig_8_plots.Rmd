...
ya_data <- df_merge %>%
  filter(Age == "YA")
ya_data$Cohort <- ifelse(ya_data$NARA>50.0, "ya_high", "ya_low")
oa_data <- df_merge %>%
  filter(Age == "OA")
...
ya_high <- subset(ya_data, Cohort == "ya_high")
oa_low <- subset(oa_data, Cohort == "oa_low")
ya_low <- subset(ya_data, Cohort == "ya_low")
```
```{r}
...
p_ct <- ggplot(df_final, aes(x=Block_num, y=Total_Time, color= Cohort))+
  ...
  geom_line(ya_high.summary, mapping = aes(x= Block_num, y = Total_Time, group = 1), size = 1.5, color = '#FF9FAF')+
  stat_summary(data = ya_high, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#FF9FAF', alpha = 1) +
  geom_line(ya_low.summary, mapping = aes(x= Block_num, y = Total_Time, group = 1), size = 1.5, color = '#fe9300')+
  stat_summary(data = ya_low, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#fe9300', alpha = 1) +
...
p_orict <- ggplot(df_final, aes(x=Block_num, y=Orientation_Time, color=Cohort))+
  ...
  geom_line(ya_high.summary, mapping = aes(x= Block_num, y = Orientation_Time, group = 1), size = 1.5, color = '#FF9FAF')+
  stat_summary(data = ya_high, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#FF9FAF', alpha = 1) +
  geom_line(ya_low.summary, mapping = aes(x= Block_num, y = Orientation_Time, group = 1), size = 1.5, color = '#fe9300')+
  stat_summary(data = ya_low, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#fe9300', alpha = 1) +
...
p_navct <- ggplot(df_final, aes(x=Block_num, y=Navigation_Time, color=Cohort))+
  ...
  geom_line(ya_high.summary, mapping = aes(x= Block_num, y = Navigation_Time, group = 1), size = 1.5, color = '#FF9FAF')+
  stat_summary(data = ya_high, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#FF9FAF', alpha = 1) +
  geom_line(ya_low.summary, mapping = aes(x= Block_num, y = Navigation_Time, group = 1), size = 1.5, color = '#fe9300')+
  stat_summary(data = ya_low, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#fe9300', alpha = 1) +
...
p_dt <- ggplot(df_final, aes(x=Block_num, y=Distance, color=Cohort))+
  ...
  geom_line(ya_high.summary, mapping = aes(x= Block_num, y = Distance, group = 1), size = 1.5, color = '#FF9FAF')+
  stat_summary(data = ya_high, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#FF9FAF', alpha = 1) +
  geom_line(ya_low.summary, mapping = aes(x= Block_num, y = Distance, group = 1), size = 1.5, color = '#fe9300')+
  stat_summary(data = ya_low, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#fe9300', alpha = 1) +
...
p_speed <- ggplot(df_final, aes(x=Block_num, y=Speed, color=Cohort))+
  ...
  geom_line(ya_high.summary, mapping = aes(x= Block_num, y = Speed, group = 1), size = 1.5, color = '#FF9FAF')+
  stat_summary(data = ya_high, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#FF9FAF', alpha = 1) +
  geom_line(ya_low.summary, mapping = aes(x= Block_num, y = Speed, group = 1), size = 1.5, color = '#fe9300')+
  stat_summary(data = ya_low, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#fe9300', alpha = 1) +
...
p_dwell <- ggplot(df_final, aes(x=Block_num, y=Mean_Dwell, color=Cohort))+
  ...
  geom_line(ya_high.summary, mapping = aes(x= Block_num, y = Mean_Dwell, group = 1), size = 1.5, color = '#FF9FAF')+
  stat_summary(data = ya_high, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#FF9FAF', alpha = 1) +
  geom_line(ya_low.summary, mapping = aes(x= Block_num, y = Mean_Dwell, group = 1), size = 1.5, color = '#fe9300')+
  stat_summary(data = ya_low, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#fe9300', alpha = 1) +
...
p_teleport <- ggplot(df_final, aes(x=Block_num, y=Teleportations, color=Cohort))+
  ...
  geom_line(ya_high.summary, mapping = aes(x= Block_num, y = Teleportations, group = 1), size = 1.5, color = '#FF9FAF')+
  stat_summary(data = ya_high, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#FF9FAF', alpha = 1) +
  geom_line(ya_low.summary, mapping = aes(x= Block_num, y = Teleportations, group = 1), size = 1.5, color = '#fe9300')+
  stat_summary(data = ya_low, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#fe9300', alpha = 1) +
