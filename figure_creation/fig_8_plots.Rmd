...
p_orict <- ggplot(df_final, aes(x=Block_num, y=Orientation_Time, color=Cohort))+
  ...
  geom_line(ya_good.summary, mapping = aes(x= Block_num, y = Orientation_Time, group = 1), size = 1.5, color = '#FF9FAF')+
  stat_summary(data = ya_good, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#FF9FAF', alpha = 1) +
  geom_line(ya_bad.summary, mapping = aes(x= Block_num, y = Orientation_Time, group = 1), size = 1.5, color = '#fe9300')+
  stat_summary(data = ya_bad, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#fe9300', alpha = 1) +
  geom_line(oa_good.summary, mapping = aes(x= Block_num, y = Orientation_Time, group = 1), size = 1.5, color = '#5E7AFA')+
  stat_summary(data = oa_good, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#5E7AFA', alpha = 1) +
  geom_line(oa_bad.summary, mapping = aes(x= Block_num, y = Orientation_Time, group = 1), size = 1.5, color = '#9dff00')+
  stat_summary(data = oa_bad, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#9dff00', alpha = 1) +
...
p_navct <- ggplot(df_final, aes(x=Block_num, y=Navigation_Time, color=Cohort))+
  ...
  geom_line(ya_good.summary, mapping = aes(x= Block_num, y = Navigation_Time, group = 1), size = 1.5, color = '#FF9FAF')+
  stat_summary(data = ya_good, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#FF9FAF', alpha = 1) +
  geom_line(ya_bad.summary, mapping = aes(x= Block_num, y = Navigation_Time, group = 1), size = 1.5, color = '#fe9300')+
  stat_summary(data = ya_bad, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#fe9300', alpha = 1) +
  geom_line(oa_good.summary, mapping = aes(x= Block_num, y = Navigation_Time, group = 1), size = 1.5, color = '#5E7AFA')+
  stat_summary(data = oa_good, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#5E7AFA', alpha = 1) +
  geom_line(oa_bad.summary, mapping = aes(x= Block_num, y = Navigation_Time, group = 1), size = 1.5, color = '#9dff00')+
  stat_summary(data = oa_bad, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#9dff00', alpha = 1) +
...
p_dt <- ggplot(df_final, aes(x=Block_num, y=Distance, color=Cohort))+
  ...
  geom_line(ya_good.summary, mapping = aes(x= Block_num, y = Distance, group = 1), size = 1.5, color = '#FF9FAF')+
  stat_summary(data = ya_good, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#FF9FAF', alpha = 1) +
  geom_line(ya_bad.summary, mapping = aes(x= Block_num, y = Distance, group = 1), size = 1.5, color = '#fe9300')+
  stat_summary(data = ya_bad, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#fe9300', alpha = 1) +
  geom_line(oa_good.summary, mapping = aes(x= Block_num, y = Distance, group = 1), size = 1.5, color = '#5E7AFA')+
  stat_summary(data = oa_good, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#5E7AFA', alpha = 1) +
  geom_line(oa_bad.summary, mapping = aes(x= Block_num, y = Distance, group = 1), size = 1.5, color = '#9dff00')+
  stat_summary(data = oa_bad, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#9dff00', alpha = 1)+
...
p_speed <- ggplot(df_final, aes(x=Block_num, y=Speed, color=Cohort))+
  ...
  geom_line(ya_good.summary, mapping = aes(x= Block_num, y = Speed, group = 1), size = 1.5, color = '#FF9FAF')+
  stat_summary(data = ya_good, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#FF9FAF', alpha = 1) +
  geom_line(ya_bad.summary, mapping = aes(x= Block_num, y = Speed, group = 1), size = 1.5, color = '#fe9300')+
  stat_summary(data = ya_bad, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#fe9300', alpha = 1) +
  geom_line(oa_good.summary, mapping = aes(x= Block_num, y = Speed, group = 1), size = 1.5, color = '#5E7AFA')+
  stat_summary(data = oa_good, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#5E7AFA', alpha = 1) +
  geom_line(oa_bad.summary, mapping = aes(x= Block_num, y = Speed, group = 1), size = 1.5, color = '#9dff00')+
  stat_summary(data = oa_bad, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#9dff00', alpha = 1)+ 
...
p_dwell <- ggplot(df_final, aes(x=Block_num, y=Mean_Dwell, color=Cohort))+
  ...
  geom_line(ya_good.summary, mapping = aes(x= Block_num, y = Mean_Dwell, group = 1), size = 1.5, color = '#FF9FAF')+
  stat_summary(data = ya_good, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#FF9FAF', alpha = 1) +
  geom_line(ya_bad.summary, mapping = aes(x= Block_num, y = Mean_Dwell, group = 1), size = 1.5, color = '#fe9300')+
  stat_summary(data = ya_bad, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#fe9300', alpha = 1) +
  geom_line(oa_good.summary, mapping = aes(x= Block_num, y = Mean_Dwell, group = 1), size = 1.5, color = '#5E7AFA')+
  stat_summary(data = oa_good, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#5E7AFA', alpha = 1) +
  geom_line(oa_bad.summary, mapping = aes(x= Block_num, y = Mean_Dwell, group = 1), size = 1.5, color = '#9dff00')+
  stat_summary(data = oa_bad, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#9dff00', alpha = 1) +
...
p_teleport <- ggplot(df_final, aes(x=Block_num, y=Teleportations, color=Cohort))+
  ...
  geom_line(ya_good.summary, mapping = aes(x= Block_num, y = Teleportations, group = 1), size = 1.5, color = '#FF9FAF')+
  stat_summary(data = ya_good, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#FF9FAF', alpha = 1) +
  geom_line(ya_bad.summary, mapping = aes(x= Block_num, y = Teleportations, group = 1), size = 1.5, color = '#fe9300')+
  stat_summary(data = ya_bad, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#fe9300', alpha = 1) +
  geom_line(oa_good.summary, mapping = aes(x= Block_num, y = Teleportations, group = 1), size = 1.5, color = '#5E7AFA')+
  stat_summary(data = oa_good, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#5E7AFA', alpha = 1) +
  geom_line(oa_bad.summary, mapping = aes(x= Block_num, y = Teleportations, group = 1), size = 1.5, color = '#9dff00')+
  stat_summary(data = oa_bad, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#9dff00', alpha = 1) +
