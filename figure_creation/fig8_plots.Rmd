...
# EF Loading Data
ya_nav_data <- read.csv('/Users/emmafunderburg/Desktop/Research/BORICH LAB/8_navaging/NavAging_Paper/data/ya_merged_results.csv')
# Tidying up the data
...
# EF Loading Data
oa_nav_data <- read.csv('/Users/emmafunderburg/Desktop/Research/BORICH LAB/8_navaging/NavAging_Paper/data/oa_merged_results.csv')
...
names(non_nav_data)[4] <- 'PSQI'
names(non_nav_data)[5] <- 'SSS_Pre'
names(non_nav_data)[6] <- 'SSS_Post'
names(non_nav_data)[7] <- 'SBSOD'
names(non_nav_data)[8] <- 'MiniCog'
names(non_nav_data)[10] <- 'TrailsA'
names(non_nav_data) [12] <- 'TrailsB'
names(non_nav_data)[14] <- 'SetShifting'
names(non_nav_data)[17] <- 'CorsiBlocks'
names(non_nav_data)[18] <- 'SSQ_Pre'
names(non_nav_data)[19] <- 'SSQ_Post'
names(non_nav_data)[39] <- 'NARA'
...
# Removing outlier - BNC39 Block 1 Target 5
...
ggsave(file="~/Desktop/Research/BORICH LAB/8_navaging/NavAging_Paper/figure_creation/plots/fig8_ct.svg", height = 5, width = 5, plot = p_ct)
```
...
ggsave(file="~/Desktop/Research/BORICH LAB/8_navaging/NavAging_Paper/figure_creation/plots/fig8_orict.svg", height = 5, width = 5, plot=p_orict)
...
ggsave(file="~/Desktop/Research/BORICH LAB/8_navaging/NavAging_Paper/figure_creation/plots/fig8_navct.svg", height = 5, width = 5, plot=p_navct)
```
...
ggsave(file="~/Desktop/Research/BORICH LAB/8_navaging/NavAging_Paper/figure_creation/plots/fig8_dt.svg", height = 5, width = 5, plot=p_dt)
...
ggsave(file="~/Desktop/Research/BORICH LAB/8_navaging/NavAging_Paper/figure_creation/plots/fig8_speed.svg", height = 5, width = 5, plot=p_speed)
...
ggsave(file="~/Desktop/Research/BORICH LAB/8_navaging/NavAging_Paper/figure_creation/plots/fig8_dwell.svg", height = 5, width = 5, plot=p_dwell)
...
ggsave(file="~/Desktop/Research/BORICH LAB/8_navaging/NavAging_Paper/figure_creation/plots/fig8_teleport.svg", height = 5, width = 5, plot=p_teleport)
...
ggsave(file="~/Desktop/Research/BORICH LAB/8_navaging/NavAging_Paper/figure_creation/plots/composite_fig8.svg", height = 16, width =20, plot=p)
