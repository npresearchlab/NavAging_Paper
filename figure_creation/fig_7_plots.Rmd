...
```{r}
p_dt <- ggplot(df_merge, aes(x=Distance, y=NARA, color = Age))+
...
```
```{r}
p_ct <- ggplot(df_merge, aes(y=NARA, x=Total_Time, color = Age))+
  geom_point(size=2, position=position_jitter(h=0,w=0.15),show.legend = TRUE) +
  scale_color_manual(values =c('#FF9FAF','#5E7AFA'))+
  #stat_summary(fun.data = ) + 
  stat_smooth(method='lm', formula= y~x)+
...
```
```{r}
p_orict <- ggplot(df_merge, aes(y=NARA, x=Orientation_Time, color = Age))+
  geom_point(size=2, position=position_jitter(h=0,w=0.15),show.legend = TRUE) +
  scale_color_manual(values =c('#FF9FAF','#5E7AFA'))+
  #stat_summary(fun.data = ) + 
  stat_smooth(method='lm', formula= y~x)+
...
```
```{r}
p_navct <- ggplot(df_merge, aes(y=NARA, x=Navigation_Time, color = Age))+
  geom_point(size=2, position=position_jitter(h=0,w=0.15),show.legend = TRUE) +
  scale_color_manual(values =c('#FF9FAF','#5E7AFA'))+
  #stat_summary(fun.data = ) + 
  stat_smooth(method='lm', formula= y~x)+
...
```
```{r}
p_speed <- ggplot(df_merge, aes(y=NARA, x=Speed, color = Age))+
  geom_point(size=2, position=position_jitter(h=0,w=0.15),show.legend = TRUE) +
  scale_color_manual(values =c('#FF9FAF','#5E7AFA'))+
  #stat_summary(fun.data = ) + 
  stat_smooth(method='lm', formula= y~x)+
...
```
```{r}
p_teleport <- ggplot(df_merge, aes(y=NARA, x=Teleportations, color = Age))+
  geom_point(size=2, position=position_jitter(h=0,w=0.15),show.legend = TRUE) +
  scale_color_manual(values =c('#FF9FAF','#5E7AFA'))+
  #stat_summary(fun.data = ) + 
  stat_smooth(method='lm', formula= y~x)+
...
```
```{r}
p_dwell <- ggplot(df_merge, aes(y=NARA, x=Mean_Dwell, color = Age))+
  geom_point(size=2, position=position_jitter(h=0,w=0.15),show.legend = TRUE) +
  scale_color_manual(values =c('#FF9FAF','#5E7AFA'))+
  #stat_summary(fun.data = ) + 
  stat_smooth(method='lm', formula= y~x)+
