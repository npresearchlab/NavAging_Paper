...
ya_nav_data <- read.csv('~/Desktop/Research/NPRL/Papers/NavAging_Paper/data_analysis/ya_averaged_results.csv')
# Tidying up the data
...
#This loads the data file as the variable "data"
oa_nav_data <- read.csv('~/Desktop/Research/NPRL/Papers/NavAging_Paper/data_analysis/oa_averaged_results.csv')
# Tidying up the data
...
```{r}
p_dt <- ggplot(df_merge, aes(x=Distance, y=NARA, color = Cohort))+
  ...
  labs(color= "Participant", y="NARA Score", x = "Distance Travelled")+
  ylim(0, 100)+
  theme_classic()+
...
```
```{r}
p_ct <- ggplot(df_merge, aes(y=NARA, x=Total_Time, color = Cohort))+
  geom_point(size=2, position=position_jitter(h=0,w=0.15),show.legend = TRUE) +
  scale_color_manual(values =c('#FF9FAF','#5E7AFA'))+
  #stat_summary(fun.data = ) + 
  stat_smooth(method='lm', formula= y~x)+
  labs(color= "Participant", x="Total Completion Time", y="NARA Score")+
  ylim(0, 100)+
  theme_classic()+
  theme(panel.background = element_rect(fill = "white", linewidth = .5, colour = "#242526"))+
  #theme(axis.line = element_line(linewidth = .5, colour = "#242526"))+
...
```
```{r}
p_orict <- ggplot(df_merge, aes(y=NARA, x=Orientation_Time, color = Cohort))+
  geom_point(size=2, position=position_jitter(h=0,w=0.15),show.legend = TRUE) +
  scale_color_manual(values =c('#FF9FAF','#5E7AFA'))+
  #stat_summary(fun.data = ) + 
  stat_smooth(method='lm', formula= y~x)+
  labs(color= "Participant", x="Orientation Time", y="NARA Score")+
  ylim(0, 100)+
  theme_classic()+
  theme(panel.background = element_rect(fill = "white", linewidth = .5, colour = "#242526"))+
  #theme(axis.line = element_line(linewidth = .5, colour = "#242526"))+
...
```
```{r}
p_navct <- ggplot(df_merge, aes(y=NARA, x=Navigation_Time, color = Cohort))+
  geom_point(size=2, position=position_jitter(h=0,w=0.15),show.legend = TRUE) +
  scale_color_manual(values =c('#FF9FAF','#5E7AFA'))+
  #stat_summary(fun.data = ) + 
  stat_smooth(method='lm', formula= y~x)+
  labs(color= "Participant", x="Navigation Time", y="NARA Score")+
  ylim(0, 100)+
  theme_classic()+
  theme(panel.background = element_rect(fill = "white", linewidth = .5, colour = "#242526"))+
  #theme(axis.line = element_line(linewidth = .5, colour = "#242526"))+
...
```
```{r}
p_speed <- ggplot(df_merge, aes(y=NARA, x=Speed, color = Cohort))+
  geom_point(size=2, position=position_jitter(h=0,w=0.15),show.legend = TRUE) +
  scale_color_manual(values =c('#FF9FAF','#5E7AFA'))+
  #stat_summary(fun.data = ) + 
  stat_smooth(method='lm', formula= y~x)+
  labs(color= "Participant", x="Speed", y="NARA Score")+
  ylim(0, 100)+
  theme_classic()+
  theme(panel.background = element_rect(fill = "white", linewidth = .5, colour = "#242526"))+
  #theme(axis.line = element_line(linewidth = .5, colour = "#242526"))+
...
```
```{r}
p_teleport <- ggplot(df_merge, aes(y=NARA, x=Teleportations, color = Cohort))+
  geom_point(size=2, position=position_jitter(h=0,w=0.15),show.legend = TRUE) +
  scale_color_manual(values =c('#FF9FAF','#5E7AFA'))+
  #stat_summary(fun.data = ) + 
  stat_smooth(method='lm', formula= y~x)+
  labs(color= "Participant", x="Teleportations", y="NARA Score")+
  ylim(0, 100)+
  theme_classic()+
  theme(panel.background = element_rect(fill = "white", linewidth = .5, colour = "#242526"))+
  #theme(axis.line = element_line(linewidth = .5, colour = "#242526"))+
...
```
```{r}
p_dwell <- ggplot(df_merge, aes(y=NARA, x=Mean_Dwell, color = Cohort))+
  geom_point(size=2, position=position_jitter(h=0,w=0.15),show.legend = TRUE) +
  scale_color_manual(values =c('#FF9FAF','#5E7AFA'))+
  #stat_summary(fun.data = ) + 
  stat_smooth(method='lm', formula= y~x)+
  labs(color= "Participant", x="Mean Dwell Time (s)", y="NARA Score")+
  ylim(0, 100)+
  theme_classic()+
  theme(panel.background = element_rect(fill = "white", linewidth = .5, colour = "#242526"))+
  #theme(axis.line = element_line(linewidth = .5, colour = "#242526"))+
