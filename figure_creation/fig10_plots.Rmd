...
p_dt <- ggplot(df_final, aes(x=Distance, y=NARA, color = Cohort, fill = Cohort))+
  ...
  scale_color_manual(values =c( 'ya' ='#FF9FAF', 'oa_low' = '#5E7AFA', 'oa_high' = '#b512e6'))+
  scale_fill_manual(values =c(  'ya' ='#FF9FAF', 'oa_low' = '#5E7AFA', 'oa_high' = '#b512e6'))+
...
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig10_dt.svg", height = 5, width = 5, plot=p_dt)
```
```{r}
...
ya_corr
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig10_ct.svg", height = 5, width = 5, plot=p_ct)
```
```{r}
...
ya_corr <- cor.test(ya_data$NARA, ya_data$Orientation_Time, 
                    method = "pearson")
ya_corr
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig10_orict.svg", height = 5, width = 5, plot=p_orict)
```
```{r}
...
ya_corr <- cor.test(ya_data$NARA, ya_data$Navigation_Time, 
                    method = "pearson")
ya_corr
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig10_navct.svg", height = 5, width = 5, plot=p_navct)
```
```{r}
...
ya_corr <- cor.test(ya_data$NARA, ya_data$Speed, 
                    method = "pearson")
ya_corr
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig10_speed.svg", height = 5, width = 5, plot=p_speed)
```
```{r}
...
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig10_teleport.svg", height = 5, width = 5, plot=p_teleport)
```
```{r}
...
ya_corr <- cor.test(ya_data$NARA, ya_data$Mean_Dwell, 
                    method = "pearson")
ya_corr
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig10_dwell.svg", height = 5, width = 5, plot=p_dwell)
```
...
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/composite_fig10.svg", height = 16, width =20, plot=p)
