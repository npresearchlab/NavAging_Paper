...
p_ct <- ggplot(df_final, aes(x=Block_num, y=Total_Time, color= Cohort))+
  scale_color_manual(values =c('#b512e6','#5E7AFA', '#FF9FAF'))+
  ...
  geom_line(oa_low.summary, mapping = aes(x= Block_num, y = Total_Time, group = 1), size = 1.5, color = '#b512e6')+
  stat_summary(data = oa_low, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#b512e6', alpha = 1) +
...
p_orict <- ggplot(df_final, aes(x=Block_num, y=Orientation_Time, color=Cohort))+
  ...
  stat_summary(data = oa_high, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#5E7AFA', alpha = 1) +
  geom_line(oa_low.summary, mapping = aes(x= Block_num, y = Orientation_Time, group = 1), size = 1.5, color = '#b512e6')+
  stat_summary(data = oa_low, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#b512e6', alpha = 1) +
...
p_navct <- ggplot(df_final, aes(x=Block_num, y=Navigation_Time, color=Cohort))+
  ...
  stat_summary(data = oa_high, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#5E7AFA', alpha = 1) +
  geom_line(oa_low.summary, mapping = aes(x= Block_num, y = Navigation_Time, group = 1), size = 1.5, color = '#b512e6')+
  stat_summary(data = oa_low, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#b512e6', alpha = 1) +
...
p_dt <- ggplot(df_final, aes(x=Block_num, y=Distance, color=Cohort))+
  ...
  stat_summary(data = oa_high, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#5E7AFA', alpha = 1) +
  geom_line(oa_low.summary, mapping = aes(x= Block_num, y = Distance, group = 1), size = 1.5, color = '#b512e6')+
  stat_summary(data = oa_low, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#b512e6', alpha = 1)+
...
p_speed <- ggplot(df_final, aes(x=Block_num, y=Speed, color=Cohort))+
  ...
  stat_summary(data = oa_high, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#5E7AFA', alpha = 1) +
  geom_line(oa_low.summary, mapping = aes(x= Block_num, y = Speed, group = 1), size = 1.5, color = '#b512e6')+
  stat_summary(data = oa_low, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#b512e6', alpha = 1)+ 
...
p_dwell <- ggplot(df_final, aes(x=Block_num, y=Mean_Dwell, color=Cohort))+
  ...
  stat_summary(data = oa_high, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#5E7AFA', alpha = 1) +
  geom_line(oa_low.summary, mapping = aes(x= Block_num, y = Mean_Dwell, group = 1), size = 1.5, color = '#b512e6')+
  stat_summary(data = oa_low, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#b512e6', alpha = 1) +
...
p_teleport <- ggplot(df_final, aes(x=Block_num, y=Teleportations, color=Cohort))+
  ...
  stat_summary(data = oa_high, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#5E7AFA', alpha = 1) +
  geom_line(oa_low.summary, mapping = aes(x= Block_num, y = Teleportations, group = 1), size = 1.5, color = '#b512e6')+
  stat_summary(data = oa_low, fun.data = mean_se, geom="errorbar",  width=0.2, size=1,  color='#b512e6', alpha = 1) +
