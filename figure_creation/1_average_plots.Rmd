---
title: "NavCity Outcomes Average Plots - Optimized"
...
save_plot(p_ct, "1_average_ct")
save_plot(p_orict, "1_average_orict") 
save_plot(p_navct, "1_average_navct")
save_plot(p_dt, "1_average_dt")
save_plot(p_speed, "1_average_speed")
save_plot(p_dwell, "1_average_dwell")
save_plot(p_teleport, "1_average_teleport")
save_plot(p_teleport_dt, "1_average_teleport_dt")
```
...
save_plot(composite_plot, "1_average_composite", width = 20, height = 20)
```
