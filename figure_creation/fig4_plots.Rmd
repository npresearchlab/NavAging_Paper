...
# Alternative paths for different users (uncomment as needed)
# data_path <- "~/Desktop/Research/NPRL/Papers/NavAging_Paper/data"
# output_path <- "~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots"
```
