...
p_ct <- ggplot(nav_data, aes(x = Block_num, y = Total_Time, color = Age)) + 
  ...
  facet_wrap(~ Target_Name, scales = "fixed", ncol = 8) + 
  ...
  geom_errorbar(data = ya_data_summary, aes(x = Block_num, ymin = Total_Time - se, ymax = Total_Time + se), 
                width = 0.2, size = 1, color = '#FF9FAF') +
  geom_line(data = oa_data_summary, aes(x = Block_num, y = Total_Time, group = 1), 
            color = '#5E7AFA', size = 1.5) +
  geom_errorbar(data = oa_data_summary, aes(x = Block_num, ymin = Total_Time - se, ymax = Total_Time + se), 
...
```{r orict, fig.height = 5, fig.width = 30, fig.align = "center"}
oa_data_summary <- oa_nav_data %>%
  group_by(Target_Name, Block_num) %>%
  summarise(
...
p_orict <- ggplot(nav_data, aes(x = Block_num, y = Orientation_Time, color = Age)) + 
  scale_color_manual(values = c('YA' = '#FF9FAF', 'OA' = '#5E7AFA')) +
  facet_wrap(~ Target_Name, scales = "fixed", ncol = 8) + 
  geom_line(aes(group = Participant), alpha = 0.2) +
  geom_point(size = 2, alpha = 0.2) +
  geom_line(data = ya_data_summary, aes(x = Block_num, y = Orientation_Time, group = 1), 
            color = '#FF9FAF', size = 1.5) +
  geom_point(size = 2, alpha = 0.2) +
  geom_errorbar(data = ya_data_summary, aes(x = Block_num, ymin = Orientation_Time - se, ymax = Orientation_Time + se), 
                width = 0.2, size = 1, color = '#FF9FAF') +
  geom_point(size = 2, alpha = 0.2) +
  geom_line(data = oa_data_summary, aes(x = Block_num, y = Orientation_Time, group = 1), 
            color = '#5E7AFA', size = 1.5) +
  geom_point(size = 2, alpha = 0.2) +
  geom_errorbar(data = oa_data_summary, aes(x = Block_num, ymin = Orientation_Time - se, ymax = Orientation_Time + se), 
                width = 0.2, size = 1, color = '#5E7AFA') +
  # Plot theme
  theme_classic() +
...
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig5_orict.svg", height = 5, width = 30, plot=p_orict)
```

# Navigation Time

```{r navct, fig.height = 5, fig.width = 30, fig.align = "center"}
oa_data_summary <- oa_nav_data %>%
  group_by(Target_Name, Block_num) %>%
  summarise(
...
p_navct <- ggplot(nav_data, aes(x = Block_num, y = Navigation_Time, color = Age)) + 
  scale_color_manual(values = c('YA' = '#FF9FAF', 'OA' = '#5E7AFA')) +
  facet_wrap(~ Target_Name, scales = "fixed", ncol = 8) + 
  geom_line(aes(group = Participant), alpha = 0.2) +
  geom_point(size = 2, alpha = 0.2) +
  geom_line(data = ya_data_summary, aes(x = Block_num, y = Navigation_Time, group = 1), 
            color = '#FF9FAF', size = 1.5) +
  geom_errorbar(data = ya_data_summary, aes(x = Block_num, ymin = Navigation_Time - se, ymax = Navigation_Time + se), 
                width = 0.2, size = 1, color = '#FF9FAF') +
  geom_line(data = oa_data_summary, aes(x = Block_num, y = Navigation_Time, group = 1), 
            color = '#5E7AFA', size = 1.5) +
  geom_errorbar(data = oa_data_summary, aes(x = Block_num, ymin = Navigation_Time - se, ymax = Navigation_Time + se), 
                width = 0.2, size = 1, color = '#5E7AFA') +
  # Plot theme
  theme_classic() +
...
p_navct
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig5_navct.svg", height = 5, width = 30, plot=p_navct)
```

# Distance

```{r dt, fig.height = 5, fig.width = 30, fig.align = "center"}
oa_data_summary <- oa_nav_data %>%
  group_by(Target_Name, Block_num) %>%
  summarise(
...
p_dt <- ggplot(nav_data, aes(x = Block_num, y = Distance, color = Age)) + 
  scale_color_manual(values = c('YA' = '#FF9FAF', 'OA' = '#5E7AFA')) +
  facet_wrap(~ Target_Name, scales = "fixed", ncol = 8) + 
  geom_line(aes(group = Participant), alpha = 0.2) +
  geom_point(size = 2, alpha = 0.2) +
  geom_line(data = ya_data_summary, aes(x = Block_num, y = Distance, group = 1), 
            color = '#FF9FAF', size = 1.5) +
  geom_errorbar(data = ya_data_summary, aes(x = Block_num, ymin = Distance - se, ymax = Distance + se), 
                width = 0.2, size = 1, color = '#FF9FAF') +
  geom_line(data = oa_data_summary, aes(x = Block_num, y = Distance, group = 1), 
            color = '#5E7AFA', size = 1.5) +
  geom_errorbar(data = oa_data_summary, aes(x = Block_num, ymin = Distance - se, ymax = Distance + se), 
                width = 0.2, size = 1, color = '#5E7AFA') +
  # Plot theme
  theme_classic() +
  labs(color = "Age", y = "Distance (VR Units)", x = "") +
  ylim(0, 1250) +
  theme(
    axis.line = element_line(linewidth = 0.5, colour = "#242526"),
    axis.ticks = element_line(linewidth = 0.2, colour = "#242526"),
...
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig5_dt.svg", height = 5, width = 30, plot=p_dt)
```

# Speed

```{r speed, fig.height = 5, fig.width = 30, fig.align = "center"}
oa_data_summary <- oa_nav_data %>%
  group_by(Target_Name, Block_num) %>%
  summarise(
    se = std.error(Speed),
...
p_speed <- ggplot(nav_data, aes(x = Block_num, y = Speed, color = Age)) + 
  scale_color_manual(values = c('YA' = '#FF9FAF', 'OA' = '#5E7AFA')) +
  facet_wrap(~ Target_Name, scales = "fixed", ncol = 8) + 
  geom_line(aes(group = Participant), alpha = 0.2) +
  geom_point(size = 2, alpha = 0.2) +
  geom_line(data = ya_data_summary, aes(x = Block_num, y = Speed, group = 1), 
            color = '#FF9FAF', size = 1.5) +
  geom_errorbar(data = ya_data_summary, aes(x = Block_num, ymin = Speed - se, ymax = Speed + se), 
                width = 0.2, size = 1, color = '#FF9FAF') +
  geom_line(data = oa_data_summary, aes(x = Block_num, y = Speed, group = 1), 
            color = '#5E7AFA', size = 1.5) +
  geom_errorbar(data = oa_data_summary, aes(x = Block_num, ymin = Speed - se, ymax = Speed + se), 
                width = 0.2, size = 1, color = '#5E7AFA') +
  # Plot theme
  theme_classic() +
  labs(color = "Age", y = "Speed (VR Units/ s)", x = "") +
  ylim(0, 30) +
  theme(
    axis.line = element_line(linewidth = 0.5, colour = "#242526"),
    axis.ticks = element_line(linewidth = 0.2, colour = "#242526"),
...
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig5_speed.svg", height = 5, width = 30, plot=p_speed)
```

# Dwell Time

```{r dwell, fig.height = 5, fig.width = 30, fig.align = "center"}
oa_data_summary <- oa_nav_data %>%
  group_by(Target_Name, Block_num) %>%
  summarise(
...
p_dwell <- ggplot(nav_data, aes(x = Block_num, y = Mean_Dwell, color = Age)) + 
  scale_color_manual(values = c('YA' = '#FF9FAF', 'OA' = '#5E7AFA')) +
  facet_wrap(~ Target_Name, scales = "fixed", ncol = 8) + 
  geom_line(aes(group = Participant), alpha = 0.2) +
  geom_point(size = 2, alpha = 0.2) +
  geom_line(data = ya_data_summary, aes(x = Block_num, y = Mean_Dwell, group = 1), 
            color = '#FF9FAF', size = 1.5) +
  geom_errorbar(data = ya_data_summary, aes(x = Block_num, ymin = Mean_Dwell - se, ymax = Mean_Dwell + se), 
                width = 0.2, size = 1, color = '#FF9FAF') +
  geom_line(data = oa_data_summary, aes(x = Block_num, y = Mean_Dwell, group = 1), 
            color = '#5E7AFA', size = 1.5) +
  geom_errorbar(data = oa_data_summary, aes(x = Block_num, ymin = Mean_Dwell - se, ymax = Mean_Dwell + se), 
                width = 0.2, size = 1, color = '#5E7AFA') +
  # Plot theme
  theme_classic() +
...
p_dwell
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig5_dwell.svg", height = 5, width = 30, plot=p_dwell)
```

# Teleportations

```{r teleport, fig.height = 5, fig.width = 30, fig.align = "center"}
oa_data_summary <- oa_nav_data %>%
  group_by(Target_Name, Block_num) %>%
  summarise(
...
p_teleport <- ggplot(nav_data, aes(x = Block_num, y = Teleportations, color = Age)) + 
  scale_color_manual(values = c('YA' = '#FF9FAF', 'OA' = '#5E7AFA')) +
  facet_wrap(~ Target_Name, scales = "fixed", ncol = 8) + 
  geom_line(aes(group = Participant), alpha = 0.2) +
  geom_point(size = 2, alpha = 0.2) +
  geom_line(data = ya_data_summary, aes(x = Block_num, y = Teleportations, group = 1), 
            color = '#FF9FAF', size = 1.5) +
  geom_errorbar(data = ya_data_summary, aes(x = Block_num, ymin = Teleportations - se, ymax = Teleportations + se), 
                width = 0.2, size = 1, color = '#FF9FAF') +
  geom_line(data = oa_data_summary, aes(x = Block_num, y = Teleportations, group = 1), 
            color = '#5E7AFA', size = 1.5) +
  geom_errorbar(data = oa_data_summary, aes(x = Block_num, ymin = Teleportations - se, ymax = Teleportations + se), 
                width = 0.2, size = 1, color = '#5E7AFA') +
  # Plot theme
  theme_classic() +
...
p_teleport
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig5_teleport.svg", height =5, width = 30, plot=p_teleport)
```

```{r comp, fig.height = 25, fig.width = 20, fig.align = "center"}
