...
```{r ct, fig.height = 5, fig.width = 15, fig.align = "center"}
#Data.summary for Total_Time for all blocks
# Total Time
p_ct <- ggplot(allblocks_targets, aes(x=Block_num, y=Total_Time_m, color=Age)) + 
  ...
  geom_errorbar(allblocks_targets, mapping = aes(x=Block_num, ymin=Total_Time_m-Total_Time_se, 
                    ymax=Total_Time_m+Total_Time_se, group = Age, color = Age), 
                width=0.1, alpha=0.7)+
...
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig5_ct.svg", height = 5, width = 10, plot=p_ct)
```
# Orientation Time
