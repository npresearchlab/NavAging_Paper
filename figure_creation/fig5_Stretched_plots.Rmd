...
```{r reading more data2, include=FALSE}
# Tidying up the data
...
ggsave(file=paste0(path_to_figs, "_ct.svg"), height = 5, width = 30, plot=p_ct)
```
# Orientation Time
...
p_orict
ggsave(file=paste0(path_to_figs, "_orict.svg"), height = 5, width = 30, plot=p_orict)
```
...
p_navct
ggsave(file=paste0(path_to_figs, "_navct.svg"), height = 5, width = 30, plot=p_navct)
```
...
ggsave(file=paste0(path_to_figs, "_dt.svg"), height = 5, width = 30, plot=p_dt)
```
...
ggsave(file=paste0(path_to_figs, "_speed.svg"), height = 5, width = 30, plot=p_speed)
```
...
p_dwell
ggsave(file=paste0(path_to_figs, "_dwell.svg"), height = 5, width = 30, plot=p_dwell)
```
...
p_teleport
ggsave(file=paste0(path_to_figs, "_teleport.svg"), height = 5, width = 30, plot=p_teleport)
```
...
p
ggsave(file=paste0(path_to_figs, "_composite.svg"), plot=p)
