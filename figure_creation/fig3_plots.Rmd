...
```{r}
path_to_figs <- "/Volumes/YB_Drive/NavAging_Paper/figure_creation/plots/fig3"
```
...
p_ct
ggsave(file=paste0(path_to_figs, "_ct.svg"), height = 5, width = 5, plot=p_ct)
```
...
p_orict <- ggplot(data, aes(x=Block_num, y=Orientation_Time, color=Age))+
  ...
  theme(axis.title.y = element_text(size=20))
p_orict
ggsave(file=paste0(path_to_figs, "_orict.svg"), height = 5, width = 5, plot=p_orict)
```
...
p_navct <- ggplot(data, aes(x=Block_num, y=Navigation_Time, color=Age))+
  ...
  theme(axis.title.y = element_text(size=20))
p_navct
ggsave(file=paste0(path_to_figs, "_navct.svg"), height = 5, width = 5, plot=p_navct)
```
...
p_dt <- ggplot(data, aes(x=Block_num, y=Distance, color=Age))+
  ...
  theme(axis.title.y = element_text(size=20))
p_dt
ggsave(file=paste0(path_to_figs, "_dt.svg"), height = 5, width = 5, plot=p_dt)
```
...
p_speed <- ggplot(data, aes(x=Block_num, y=Speed, color=Age))+
  ...
  theme(axis.title.y = element_text(size=20))
p_speed
ggsave(file=paste0(path_to_figs, "_speed.svg"), height = 5, width = 5, plot=p_speed)
```
...
p_dwell <- ggplot(data, aes(x=Block_num, y=Mean_Dwell, color=Age))+
  ...
  theme(axis.title.y = element_text(size=20))
p_dwell
ggsave(file=paste0(path_to_figs, "_dwell.svg"), height = 5, width = 5, plot=p_dwell)
``` 
...
p_teleport <- ggplot(data, aes(x=Block_num, y=Teleportations, color=Age))+
  ...
  theme(axis.title.y = element_text(size=20))
p_teleport
ggsave(file=paste0(path_to_figs, "_teleport.svg"), height = 5, width = 5, plot=p_teleport)
```
...
ggsave(file=paste0(path_to_figs, "_composite.svg"), height = 16, width =20, plot=p)
```
