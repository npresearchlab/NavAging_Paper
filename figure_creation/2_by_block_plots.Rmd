---
title: "NavCity Outcomes By Block Code - Optimized"
...
plot_specs <- tribble(
  ...
  "Distance",               "Distance Traveled (m)",             c(0,1200),   seq(0, 1200, 200),
  "Speed",                  "Speed (m/s)",                       c(0,30),     seq(0, 30, 5),
  "Mean_Dwell",             "Dwell Duration (s)",                c(0, 5),     seq(0, 5, 1),
  "Teleportations",         "Teleportations (count)",            c(0,250),    NULL,
  "Mean_Teleport_Distance", "Teleport Distance (m)",             c(0,8),    NULL
)
...
plot_names <- c("2_by_block_ct", "2_by_block_orict", "2_by_block_navct", "2_by_block_dt", 
                "2_by_block_speed", "2_by_block_dwell", "2_by_block_teleport", "2_by_block_teleport_dt")
...
save_plot(composite_plot, "2_by_block_composite", width = 20, height = 20)
```
