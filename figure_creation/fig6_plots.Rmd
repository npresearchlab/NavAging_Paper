...
ya_data <- read.csv('~/Desktop/NPRL (RS)/NAVIGATION/NavAging_Paper/data_analysis/ya_averaged_results.csv')
# Tidying up the data
...
oa_data <- read.csv('~/Desktop/NPRL (RS)/NAVIGATION/NavAging_Paper/data_analysis/oa_averaged_results.csv')
# Tidying up the data
...
ya_nav_data <- read.csv('~/Desktop/NPRL (RS)/NAVIGATION/NavAging_Paper/data_analysis/ya_merged_results.csv')
...
oa_nav_data <- read.csv('~/Desktop/NPRL (RS)/NAVIGATION/NavAging_Paper/data_analysis/ya_merged_results.csv')
# Tidying up the data
...
non_nav_data <- read.csv('~/Desktop/NPRL (RS)/NAVIGATION/NavAging_Paper/data_analysis/non_nav_data.csv')
# Tidying up the data
...
corr_nara + scale_fill_manual(values =c('#FF9FAF','#5E7AFA'))
```