...
#ggsave(file="~/Desktop/NPRL (RS)/NAVIGATION/NavAging_Paper/figure_creation/plots/fig6_rain_nara.svg", height = 5, width = 5, plot=corr_nara)
```
...
corr_nara_three <-ggplot(non_nav_data_final, aes(x=age, y=nara, color = group))+
  geom_point(size=2)+
  #labs(color = c('#FF9FAF','#5E7AFA'))+
  scale_color_manual(values =c('#5E7AFA','#FF9FAF'))+
  theme_classic()+
