---
title: "NARA Cohorts Average Plots Code - Optimized"
...
create_cohort_raincloud <- function(data, y_var, y_label, y_limits = NULL, 
  ...
  p <- ggplot(data, aes(x = Cohort, y = .data[[y_var]], fill = Cohort, color = Cohort)) +
    ...
    scale_x_discrete(labels = c("YA", expression(OA[High]), expression(OA[Low]))) +
...
plot_names <- c("6_cohorts_average_ct", "6_cohorts_average_orict", "6_cohorts_average_navct",
                "6_cohorts_average_dt", "6_cohorts_average_speed", "6_cohorts_average_dwell",
                "6_cohorts_average_teleport", "6_cohorts_average_teleport_dt")
...
save_plot(composite_plot, "6_cohorts_average_composite", width = 20, height = 20)
```
