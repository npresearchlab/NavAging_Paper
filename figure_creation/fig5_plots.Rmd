...
p_ct <- ggplot(ya_allblocks_targets, aes(x=Block_num, y=Total_Time_m, shape=Target_Name))+
...
#Total_time by Target_Name
oa_p_ct <- ggplot(oa_allblocks_targets, aes(x=Block_num, y=Total_Time_m, shape=Target_Name))+
...
p_orict <- ggplot(allblocks_targets, aes(x=Block_num, y=Orientation_Time_m, shape=Target_Name))+
  ...
  theme(axis.title.x = element_text(size=20))
p_orict
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig5_orict.svg", height = 4, width = 5, plot=p_orict)
```
...
p_navct <- ggplot(allblocks_targets, aes(x=Block_num, y=Navigation_Time_m, shape=Target_Name))+
  ...
  theme(axis.title.x = element_text(size=20))
p_navct
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig5_navct.svg", height = 4, width = 5, plot=p_navct)
```
...
p_dt <- ggplot(allblocks_targets, aes(x=Block_num, y=Distance_m, shape=Target_Name))+
  ...
  theme(axis.title.x = element_text(size=20))
p_dt
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig5_dt.svg", height = 4, width = 5, plot=p_dt)
```
...
p_speed <- ggplot(allblocks_targets, aes(x=Block_num, y=Speed_m, shape=Target_Name))+
  ...
  theme(axis.title.x = element_text(size=20))
p_speed
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig5_speed.svg", height = 4, width = 5, plot=p_speed)
```
...
p_dwell <- ggplot(allblocks_targets, aes(x=Block_num, y=Mean_Dwell_m, shape=Target_Name))+
  ...
  theme(axis.title.x = element_text(size=20))
p_dwell
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig5_dwell.svg", height = 4, width = 5, plot=p_dwell)
```
...
p_teleport <- ggplot(allblocks_targets, aes(x=Block_num, y=Teleportations_m, shape=Target_Name))+
  ...
  theme(axis.title.x = element_text(size=20))
p_teleport
ggsave(file="~/Desktop/Research/NPRL/Papers/NavAging_Paper/figure_creation/plots/fig5_teleport.svg", height = 4, width = 5, plot=p_teleport)
```
