...
oa_b1 <- subset(nav_data, Block_num == 1| Age =='OA')
rownames(oa_b1) <- NULL 
oa_b2 <- subset(nav_data, Block_num == 2| Age =='OA')
rownames(oa_b2) <- NULL 
oa_b3 <- subset(nav_data, Block_num == 3| Age =='OA')
rownames(oa_b3) <- NULL 
...
#Total_time by Target_Name
ya_p_speed <- ggplot(ya_allblocks_targets, aes(x=Block_num, y=Speed_m, shape=Target_Name))+
