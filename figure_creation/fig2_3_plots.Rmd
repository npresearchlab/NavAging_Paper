...
save_plot(p_navct, "fig2_3_navct")
save_plot(p_dt, "fig2_3_dt")
save_plot(p_speed, "fig2_3_speed")
save_plot(p_dwell, "fig2_3_dwell")
save_plot(p_teleport, "fig2_3_teleport")
save_plot(p_teleport_dt, "fig2_3_teleport_dt")
```
