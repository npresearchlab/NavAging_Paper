...
p_teleport_dist <- create_raincloud_plot(
  mean_data, 
  "Mean_Teleport_Distance", 
  "Mean Teleport Distance (m)"
)
```
...
save_plot(p_teleport_dist, "fig2_teleport_dist")
```
...
save_plot(composite_plot, "fig2_composite", width = 20, height = 20)
```
