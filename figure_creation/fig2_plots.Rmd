...
p_ct <- ggplot(data, aes(x=Block_num, y=Total_Time, color=Age))+
  ...
  #stat_summary(data = ya_data, fun = mean, geom = "line", aes(group = 1), size = 1,color='#FF9FAF', alpha = .5)+
  ...
  #stat_summary(data = oa_data, fun = mean, geom = "line", aes(group = 1), size = 1,color='#5E7AFA', alpha = .5)+
...
p_orict <- ggplot(data, aes(x=Block_num, y=Orientation_Time, color=Age))+
  geom_line(data, mapping = aes(x= Block_num, y = Orientation_Time, group = Age, color = Age), alpha = .3)+
  scale_color_viridis(option = "plasma", discrete = TRUE)+
  geom_point(data, mapping = aes(x= Block_num, y = Orientation_Time, group = Age),color = 'white', size = 5)+
  geom_point(data, mapping = aes(x= Block_num, y = Orientation_Time, group = Age, color = Age), size = 3, alpha = .5)+
...
p_navct <- ggplot(data, aes(x=Block_num, y=Navigation_Time, color=Age))+
  geom_line(data, mapping = aes(x= Block_num, y = Navigation_Time, group = Age, color = Age), alpha = .3)+
  scale_color_viridis(option = "plasma", discrete = TRUE)+
  geom_point(data, mapping = aes(x= Block_num, y = Navigation_Time, group = Age),color = 'white', size = 5)+
  geom_point(data, mapping = aes(x= Block_num, y = Navigation_Time, group = Age, color = Age),size = 3, alpha = .5)+
...
p_dt <- ggplot(data, aes(x=Block_num, y=Distance, color=Age))+
  geom_line(data, mapping = aes(x= Block_num, y = Distance, group = Age, color = Age), alpha = .3)+
  scale_color_viridis(option = "plasma", discrete = TRUE)+
  geom_point(data, mapping = aes(x= Block_num, y = Distance, group = Age),color = 'white', size = 5)+
  geom_point(data, mapping = aes(x= Block_num, y = Distance, group = Age, color = Age), size = 3, alpha = .5)+
...
p_speed <- ggplot(data, aes(x=Block_num, y=Speed, color=Age))+
  geom_line(data, mapping = aes(x= Block_num, y = Speed, group = Age, color = Age), alpha = .3)+
  scale_color_viridis(option = "plasma", discrete = TRUE)+
  geom_point(data, mapping = aes(x= Block_num, y = Speed, group = Age),color = 'white', size = 5)+
  geom_point(data, mapping = aes(x= Block_num, y = Speed, group = Age, color = Age), size = 3, alpha = .5)+
...
p_dwell <- ggplot(data, aes(x=Block_num, y=Mean_Dwell, color=Age))+
  geom_line(data, mapping = aes(x= Block_num, y = Mean_Dwell, group = Age, color = Age), alpha = .3)+
  scale_color_viridis(option = "plasma", discrete = TRUE)+
  geom_point(data, mapping = aes(x= Block_num, y = Mean_Dwell, group = Age),color = 'white', size = 5)+
  geom_point(data, mapping = aes(x= Block_num, y = Mean_Dwell, group = Age, color = Age), size = 3, alpha = .5)+
...
p_teleport <- ggplot(data, aes(x=Block_num, y=Teleportations, color=Age))+
  geom_line(data, mapping = aes(x= Block_num, y = Teleportations, group = Age, color = Age), alpha = .3)+
  scale_color_viridis(option = "plasma", discrete = TRUE)+
  geom_point(data, mapping = aes(x= Block_num, y = Teleportations, group = Age),color = 'white', size = 5)+
  geom_point(data, mapping = aes(x= Block_num, y = Teleportations, group = Age, color = Age), size = 3, alpha = .5)+
