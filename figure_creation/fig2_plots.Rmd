...
p_ct <- ggplot(data, aes(x=Block_num, y=Total_Time, color=Age))+
  ...
  #ßgeom_line(data, mapping = aes(x= Block_num, y = Total_Time, group = Age, color = Age), alpha = .3)+
  #geom_point(data, mapping = aes(x= Block_num, y = Total_Time, group = Age), color = 'white', size = 5)+
  geom_point(data, mapping = aes(x= Block_num, y = Total_Time, group = Age, color = Age), size = 3, alpha = .5)+
