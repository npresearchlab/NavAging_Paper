...
change_plot_names <- paste0("fig9_10a_", plot_specs$plot_name, "_change")
...
mean_plot_names <- paste0("fig9_10b_", mean_plot_specs$plot_name)
...
save_plot(composite_change_plot, "fig9_change_composite", width = 20, height = 20)
```
...
save_plot(composite_mean_plot, "fig9_mean_composite", width = 20, height = 20)
```
