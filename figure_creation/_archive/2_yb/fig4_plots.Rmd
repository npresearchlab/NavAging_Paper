...
```{r}
ya_data <- read.csv('/Volumes/YB_Drive/NavAging_Paper/data/ya_merged_results.csv')
oa_data <- read.csv('/Volumes/YB_Drive/NavAging_Paper/data/oa_merged_results.csv')
non_nav_data <- read.csv('/Volumes/YB_Drive/NavAging_Paper/data/non_nav_data.csv')

# CHANGE THE END DEPENDING ON YOUR FIG NUMBER
path_to_figs <- "/Volumes/YB_Drive/NavAging_Paper/figure_creation/plots/fig4"
```
...
p_ct
ggsave(file=paste0(path_to_figs, "_ct.svg"), height = 4, width = 6.5, plot=p_ct)
```
...
p_orict <- ggplot(target_data_all, aes(x=Target_Name, y=Orientation_Time, color=Age))+
  ...
  theme(axis.title.x = element_text(size=20))
p_orict
ggsave(file=paste0(path_to_figs, "_orict.svg"), height = 4, width = 6.5, plot=p_orict)
```
...
p_navct <- ggplot(target_data_all, aes(x=Target_Name, y=Navigation_Time, color=Age))+
  ...
  theme(axis.title.x = element_text(size=20))
p_navct
ggsave(file=paste0(path_to_figs, "_navct.svg"), height = 4, width = 6.5, plot=p_navct)
```
...
p_dwell <- ggplot(target_data_all, aes(x=Target_Name, y=Mean_Dwell, color=Age))+
  ...
  theme(axis.title.x = element_text(size=20))
p_dwell
ggsave(file=paste0(path_to_figs, "_dwell.svg"), height = 4, width = 6.5, plot=p_dwell)
```
...
p_dt <- ggplot(target_data_all, aes(x=Target_Name, y=Distance, color=Age))+
  ...
  theme(axis.title.x = element_text(size=20))
p_dt
ggsave(file=paste0(path_to_figs, "_dt.svg"), height = 4, width = 6.5, plot=p_dt)
```
...
p_speed <- ggplot(target_data_all, aes(x=Target_Name, y=Speed, color=Age))+
  ...
  theme(axis.title.x = element_text(size=20))
p_speed
ggsave(file=paste0(path_to_figs, "_speed.svg"), height = 4, width = 6.5, plot=p_speed)
```
...
p_teleport <- ggplot(target_data_all, aes(x=Target_Name, y=Teleportations, color=Age))+
  ...
  theme(axis.title.x = element_text(size=20))
p_teleport
ggsave(file=paste0(path_to_figs, "_teleport.svg"), height = 4, width = 6.5, plot=p_teleport)
```
