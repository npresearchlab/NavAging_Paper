---
title: "NavCity Outcomes By Target Code - Optimized"
...
save_plot <- function(plot, filename, width = 6.5, height = 5.5) {
  ggsave(
...
plot_names <- c("3_by_target_ct", "3_by_target_orict", "3_by_target_navct", "3_by_target_dt", 
                "3_by_target_speed", "3_by_target_dwell", "3_by_target_teleport", "3_by_target_teleport_dt")
...
composite_plot <- grid.arrange(
  ...
  p_speed, p_dwell, p_teleport, p_teleport_dt,   # Row 2
  ncol = 4, 
  nrow = 2
)

# Save composite figure
save_plot(composite_plot, "3_by_target_composite", width = 20, height = 12)
```
