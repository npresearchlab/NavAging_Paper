...
path_to_figs <- "/Volumes/YB_Drive/NavAging_Paper/figure_creation/plots/fig5_barplots"
```
...
allblocks_targets.summary <- ya_test_allblocks_targets %>%
  group_by(Block_num) %>%
  summarise(
    se = std.error(Total_Time_m),
    Orientation_Time = mean(Total_Time_m)
  )
  
#Total_time by Target_Name
ya_p_ct <- ggplot(allblocks_targets, aes(x=Block_num, y=Total_Time_m, shape=Target_Name))+
  geom_line(ya_test_allblocks_targets, mapping = aes(x= Block_num, y = Total_Time_m,
                                             group = Target_Name, 
  ...
  geom_point(ya_test_allblocks_targets, mapping = aes(x= Block_num, 
                                              y = Total_Time_m, 
                                              group = Target_Name, 
                                              color = Target_Name,
                                              fill = Target_Name),
             alpha = 1, size = 3)+
  geom_errorbar(ya_test_allblocks_targets, mapping = aes(x=Block_num, ymin=Total_Time_m-Total_Time_se, 
...
#Data.summary for Total_Time for all blocks
allblocks_targets.summary <- oa_test_allblocks_targets %>%
  group_by(Block_num) %>%
  summarise(
    se = std.error(Total_Time_m),
    Orientation_Time = mean(Total_Time_m)
...
oa_p_ct <- ggplot(allblocks_targets, aes(x=Block_num, y=Total_Time_m, shape=Target_Name))+
  geom_line(oa_test_allblocks_targets, mapping = aes(x= Block_num, y = Total_Time_m,
                                             group = Target_Name, 
                                             color = Target_Name), alpha = 0.7)+
  scale_color_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  scale_fill_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  scale_shape_manual(values= c(7, 8, 12, 21, 22, 23, 24, 25))+
  geom_point(oa_test_allblocks_targets, mapping = aes(x= Block_num, 
                                              y = Total_Time_m, 
                                              group = Target_Name, 
                                              color = Target_Name,
                                              fill = Target_Name),
             alpha = 1, size = 3)+
  geom_errorbar(oa_test_allblocks_targets, mapping = aes(x=Block_num, ymin=Total_Time_m-Total_Time_se, 
                    ymax=Total_Time_m+Total_Time_se, group = Target_Name, color = Target_Name), 
                width=0.1, alpha=0.7)+
  labs(color= "Target_Name", y="Total Time (s)", x = "Block Number")+
  theme_classic()+
...
ggsave(file=paste0(path_to_figs, "_ct.svg"), height = 5, width = 10, plot=p_ct)
```
...
ya_p_orict <- ggplot(allblocks_targets, aes(x=Block_num, y=Orientation_Time_m, shape=Target_Name))+
  geom_line(ya_test_allblocks_targets, mapping = aes(x= Block_num, y = Orientation_Time_m,
                                             group = Target_Name, 
                                             color = Target_Name), alpha = 0.7)+
  scale_color_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  scale_fill_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  ...
  geom_point(ya_test_allblocks_targets, mapping = aes(x= Block_num, 
                                              ...
                                              fill = Target_Name),
             alpha = 1, size = 3)+
  geom_errorbar(ya_test_allblocks_targets, mapping = aes(x=Block_num, ymin=Orientation_Time_m-Orientation_Time_se, 
...
oa_p_orict <- ggplot(allblocks_targets, aes(x=Block_num, y=Orientation_Time_m, shape=Target_Name))+
  geom_line(oa_test_allblocks_targets, mapping = aes(x= Block_num, y = Orientation_Time_m,
                                             group = Target_Name, 
                                             color = Target_Name), alpha = 0.7)+
  scale_color_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  scale_fill_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  ...
  geom_point(oa_test_allblocks_targets, mapping = aes(x= Block_num, 
                                              ...
                                              fill = Target_Name),
             alpha = 1, size = 3)+
  geom_errorbar(oa_test_allblocks_targets, mapping = aes(x=Block_num, ymin=Orientation_Time_m-Orientation_Time_se, 
                    ymax=Orientation_Time_m+Orientation_Time_se, group = Target_Name, color = Target_Name), 
                width=0.1, alpha=0.7)+
  labs(color= "Target_Name", y="Orientation Time (s)", x = "Block Number")+
  theme_classic()+
...
ggsave(file=paste0(path_to_figs, "_orict.svg"), height = 5, width = 10, plot=p_orict)
```
...
ya_p_navct <- ggplot(allblocks_targets, aes(x=Block_num, y=Navigation_Time_m, shape=Target_Name))+
  geom_line(ya_test_allblocks_targets, mapping = aes(x= Block_num, y = Navigation_Time_m,
                                             group = Target_Name, 
                                             color = Target_Name), alpha = 0.7)+
  scale_color_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  scale_fill_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  ...
  geom_point(ya_test_allblocks_targets, mapping = aes(x= Block_num, 
                                              ...
                                              fill = Target_Name),
             alpha = 1, size = 3)+
  geom_errorbar(ya_test_allblocks_targets, mapping = aes(x=Block_num, ymin=Navigation_Time_m-Navigation_Time_se, 
...
oa_p_navct <- ggplot(allblocks_targets, aes(x=Block_num, y=Navigation_Time_m, shape=Target_Name))+
  geom_line(oa_test_allblocks_targets, mapping = aes(x= Block_num, y = Navigation_Time_m,
                                             group = Target_Name, 
                                             color = Target_Name), alpha = 0.7)+
  scale_color_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  scale_fill_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  ...
  geom_point(oa_test_allblocks_targets, mapping = aes(x= Block_num, 
                                              ...
                                              fill = Target_Name),
             alpha = 1, size = 3)+
  geom_errorbar(oa_test_allblocks_targets, mapping = aes(x=Block_num, ymin=Navigation_Time_m-Navigation_Time_se, 
                    ymax=Navigation_Time_m+Navigation_Time_se, group = Target_Name, color = Target_Name), 
                width=0.1, alpha=0.7)+
  labs(color= "Target_Name", y="Navigation Time (s)", x = "Block Number")+
  theme_classic()+
...
ggsave(file=paste0(path_to_figs, "_navct.svg"), height = 5, width = 10, plot=p_navct)
```
...
ya_p_dt <- ggplot(allblocks_targets, aes(x=Block_num, y=Distance_m, shape=Target_Name))+
  geom_line(ya_test_allblocks_targets, mapping = aes(x= Block_num, y = Distance_m,
                                             group = Target_Name, 
                                             color = Target_Name), alpha = 0.7)+
  scale_color_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  scale_fill_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  ...
  geom_point(ya_test_allblocks_targets, mapping = aes(x= Block_num, 
                                              ...
                                              fill = Target_Name),
             alpha = 1, size = 3)+
  geom_errorbar(ya_test_allblocks_targets, mapping = aes(x=Block_num, ymin=Distance_m-Distance_se, 
...
oa_p_dt <- ggplot(allblocks_targets, aes(x=Block_num, y=Distance_m, shape=Target_Name))+
  geom_line(oa_test_allblocks_targets, mapping = aes(x= Block_num, y = Distance_m,
                                             group = Target_Name, 
                                             color = Target_Name), alpha = 0.7)+
  scale_color_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  scale_fill_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  ...
  geom_point(oa_test_allblocks_targets, mapping = aes(x= Block_num, 
                                              ...
                                              fill = Target_Name),
             alpha = 1, size = 3)+
  geom_errorbar(oa_test_allblocks_targets, mapping = aes(x=Block_num, ymin=Distance_m-Distance_se, 
                    ymax=Distance_m+Distance_se, group = Target_Name, color = Target_Name), 
                width=0.1, alpha=0.7)+
  labs(color= "Target_Name", y="Distance (VR Units)", x = "Block Number")+
  theme_classic()+
...
ggsave(file=paste0(path_to_figs, "_dt.svg"), height = 5, width = 10, plot=p_dt)
```
...
ya_p_speed <- ggplot(allblocks_targets, aes(x=Block_num, y=Speed_m, shape=Target_Name))+
  geom_line(ya_test_allblocks_targets, mapping = aes(x= Block_num, y = Speed_m,
                                             group = Target_Name, 
                                             color = Target_Name), alpha = 0.7)+
  scale_color_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  scale_fill_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  ...
  geom_point(ya_test_allblocks_targets, mapping = aes(x= Block_num, 
                                              ...
                                              fill = Target_Name),
             alpha = 1, size = 3)+
  geom_errorbar(ya_test_allblocks_targets, mapping = aes(x=Block_num, ymin=Speed_m-Speed_se, 
...
#Total_time by Target_Name
oa_p_speed <- ggplot(allblocks_targets, aes(x=Block_num, y=Speed_m, shape=Target_Name))+
  geom_line(oa_test_allblocks_targets, mapping = aes(x= Block_num, y = Speed_m,
                                             group = Target_Name, 
                                             color = Target_Name), alpha = 0.7)+
  scale_color_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  scale_fill_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  ...
  geom_point(oa_test_allblocks_targets, mapping = aes(x= Block_num, 
                                              ...
                                              fill = Target_Name),
             alpha = 1, size = 3)+
  geom_errorbar(oa_test_allblocks_targets, mapping = aes(x=Block_num, ymin=Speed_m-Speed_se, 
                    ymax=Speed_m+Speed_se, group = Target_Name, color = Target_Name), 
                width=0.1, alpha=0.7)+
  labs(color= "Target_Name", y="Speed (VR Units / s)", x = "Block Number")+
  theme_classic()+
...
ggsave(file=paste0(path_to_figs, "_speed.svg"), height = 5, width = 10, plot=p_speed)
```
...
ya_p_dwell <- ggplot(allblocks_targets, aes(x=Block_num, y=Mean_Dwell_m, shape=Target_Name))+
  geom_line(ya_test_allblocks_targets, mapping = aes(x= Block_num, y = Mean_Dwell_m,
                                             group = Target_Name, 
                                             color = Target_Name), alpha = 0.7)+
  scale_color_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  scale_fill_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  ...
  geom_point(ya_test_allblocks_targets, mapping = aes(x= Block_num, 
                                              ...
                                              fill = Target_Name),
             alpha = 1, size = 3)+
  geom_errorbar(ya_test_allblocks_targets, mapping = aes(x=Block_num, ymin=Mean_Dwell_m-Mean_Dwell_se, 
...
oa_p_dwell <- ggplot(allblocks_targets, aes(x=Block_num, y=Mean_Dwell_m, shape=Target_Name))+
  geom_line(oa_test_allblocks_targets, mapping = aes(x= Block_num, y = Mean_Dwell_m,
                                             group = Target_Name, 
                                             color = Target_Name), alpha = 0.7)+
  scale_color_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  scale_fill_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  ...
  geom_point(oa_test_allblocks_targets, mapping = aes(x= Block_num, 
                                              ...
                                              fill = Target_Name),
             alpha = 1, size = 3)+
  geom_errorbar(oa_test_allblocks_targets, mapping = aes(x=Block_num, ymin=Mean_Dwell_m-Mean_Dwell_se, 
                    ymax=Mean_Dwell_m+Mean_Dwell_se, group = Target_Name, color = Target_Name), 
                width=0.1, alpha=0.7)+
  labs(color= "Target_Name", y="Dwell Time (s)", x = "Block Number")+
  theme_classic()+
...
ggsave(file=paste0(path_to_figs, "_dwell.svg"), height = 5, width = 10, plot=p_dwell)
```
...
ya_p_teleport <- ggplot(allblocks_targets, aes(x=Block_num, y=Teleportations_m, shape=Target_Name))+
  geom_line(ya_test_allblocks_targets, mapping = aes(x= Block_num, y = Teleportations_m,
                                             group = Target_Name, 
                                             color = Target_Name), alpha = 0.7)+
  scale_color_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  scale_fill_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  ...
  geom_errorbar(ya_test_allblocks_targets, mapping = aes(x=Block_num, ymin=Teleportations_m-Teleportations_se, 
...
oa_p_teleport <- ggplot(allblocks_targets, aes(x=Block_num, y=Teleportations_m, shape=Target_Name))+
  geom_line(oa_test_allblocks_targets, mapping = aes(x= Block_num, y = Teleportations_m,
                                             group = Target_Name, 
                                             color = Target_Name), alpha = 0.7)+
  scale_color_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  scale_fill_manual(values = c("#404BA4", "#734BB7", "#9B4BBE", "#BC58B0", "#D5709D", "#E78B88", "#F7A779", "#FEC869"))+
  ...
  geom_point(oa_test_allblocks_targets, mapping = aes(x= Block_num, 
             ...
             alpha = 1, size = 3)+
  labs(color= "Target_Name", y="Teleportations (count)", x = "Block Number")+
  geom_errorbar(oa_test_allblocks_targets, mapping = aes(x=Block_num, ymin=Teleportations_m-Teleportations_se, 
                    ymax=Teleportations_m+Teleportations_se, group = Target_Name, color = Target_Name), 
                width=0.1, alpha=0.7)+
  theme_classic()+
  ylim(0,200)+
...
ggsave(file=paste0(path_to_figs, "_teleport.svg"), height = 5, width = 10, plot=p_teleport)
```
